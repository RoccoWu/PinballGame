...
public partial class @PlayerInput : IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": []
        ...
        m_Player_FliiperRight = m_Player.FindAction("FliiperRight", throwIfNotFound: true);
    ...
    private readonly InputAction m_Player_FliiperRight;
    ...
    public struct PlayerActions
    {
        ...
        public InputAction @FliiperRight => m_Wrapper.m_Player_FliiperRight;
        ...
        public void SetCallbacks(IPlayerActions instance)
        {
            ...
            {
                @FliiperRight.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnFliiperRight;
                @FliiperRight.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnFliiperRight;
                @FliiperRight.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnFliiperRight;
            ...
            if (instance != null)
            {
                @FliiperRight.started += instance.OnFliiperRight;
                @FliiperRight.performed += instance.OnFliiperRight;
                @FliiperRight.canceled += instance.OnFliiperRight;
    ...
    {
        void OnFliiperRight(InputAction.CallbackContext context);
